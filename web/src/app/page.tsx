...
export default function Dashboard() {
  ...
  // Filter tools by search query against name, category, and description
      ...
      <div className="p-4 sm:p-8 max-w-4xl">
          ...
          <div className="mb-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 text-sm border border-zinc-200 dark:border-zinc-800 rounded-lg bg-white dark:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-400 placeholder:text-zinc-400"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-zinc-400 dark:text-zinc-500 text-sm">No tools match &ldquo;{search}&rdquo;</p>
          </div>
        ) : (
          <div className="space-y-4">
            {filtered.map((tool, i) => (
              <div
                ...
                className={`transition-all duration-150 ${
                  ...
                  dragOverIndex === i && dragIndex !== i ? "border-t-2 border-zinc-400 dark:border-zinc-500 pt-1" : ""
                }`}
              >
