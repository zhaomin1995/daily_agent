...
export default function MobileHeader() {
  ...
  return (
    <header className="md:hidden sticky top-0 z-40 border-b border-zinc-200 bg-white/90 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-950/90 px-4 pb-4 flex items-center justify-between safe-area-top">
      <div>
